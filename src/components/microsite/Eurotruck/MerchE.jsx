...
import { SlideUp, SlideLeft, SlideRight, ZoomIn } from '../../animations/animation';
...
export default function MerchSection() {
  ...
  const products = [
    {
      id: 1,
      name: "PRODUKT #1",
      description: "Eurotruck tričko",
      image: "/merch/shirteuro.png",
      link: "https://www.redbubble.com/i/hoodie/Lovers-of-Euro-Truck-Simulator-2-by-alexadybanu/99821748.YFBT8"
    },
    {
      id: 2,
      name: "PRODUKT #2",
      description: "Mikina s kapucí Eurotruck",
      image: "/merch/mikinaeuro.png",
      link: "https://www.xzone.cz/tricko-euro-truck-simulator-cerne-s-logem-l?srsltid=AfmBOopID6ZHGVm-SuPRDH9gArgPh4px-1psXZjjoz3P7Gh8l8PhIG-X"
    },
    {
      id: 3,
      name: "PRODUKT #3",
      description: "Euro Truck Mousepad",
      image: "/merch/mousepadeuro.png",
      link: "https://www.redbubble.com/i/mouse-pad/Euro-Truck-Simulator-2-MAP-by-alexadybanu/161305542.G1FH6"
    }
  ];
  ...
  return (
    <div id='merch' ref={containerRef} className="text-black bg-[#D9DDD9] w-full min-h-[90vh] flex flex-col items-center justify-center p-4 md:p-8">
      {/* 🛍 Nadpis sekce */}
      <motion.h1
        variants={ZoomIn(0.1)}
        initial="initial"
