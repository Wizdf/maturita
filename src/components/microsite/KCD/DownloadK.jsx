...
import img1 from "../../../assets/KCD/aboutkcd.webp";
import img2 from "../../../assets/KCD/headerk.jpeg";
import img3 from "../../../assets/KCD/kcd1.jpg";
import img4 from "../../../assets/KCD/kcd2.jpg";
import img5 from "../../../assets/KCD/kcd3.jpg";
import img6 from "../../../assets/KCD/kcdmain.webp";
import img7 from "../../../assets/KCD/kcd.png";
      ...
      <section className="min-h-screen w-full bg-white flex flex-col items-center justify-center gap-10 px-4 py-10 text-center">
        ...
        >
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/IzzieiKGL_o?si=bJ2h5xM0odF0Y7w5"
        ...
        <motion.a
          ...
          whileInView="animate"
          viewport={{ once: true }}
          href="https://store.steampowered.com/curator/44981550"
          target="_blank"
